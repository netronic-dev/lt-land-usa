    ...
    >
      ...
      <div className="container lg:flex lg:items-center lg:justify-between">
        ...
        <ul className="mt-[99px] lg:mt-0 flex items-center flex-wrap justify-center md:mt-[80px] lg:justify-end">
          ...
          <li
            ref={itemTwoRef}
            className={`${style.itemTwo} aboutUsSection-item-width ml-[-20px] md:ml-[-30px] px-[37px] py-[77px] flex items-center xl:w-[266px] xl:h-[266px] lg:w-[252px] lg:h-[252px] md:w-[360px] md:h-[360px] w-[175px] h-[175px] justify-center rounded-[50%] border-solid border-[1px] border-[#A8A8A8] bg-[transparent]`}
          >
            <Icon
          ...
          <li
            ref={itemFourRef}
            className={`${style.itemFour} aboutUsSection-item-width mt-[-15px] md:mt-[-20px] px-[37px] py-[77px] flex items-center xl:w-[266px] xl:h-[266px] lg:w-[252px] lg:h-[252px] md:w-[360px] md:h-[360px] w-[175px] h-[175px] justify-center rounded-[50%] border-solid border-[1px] border-[#A8A8A8] bg-[transparent]`}
          >
            <Icon
          ...
          <li
            ref={itemThreeRef}
            className={`${style.itemThree} aboutUsSection-item-width mt-[-15px] ml-[-20px] md:ml-[-30px] md:mt-[-20px] px-[37px] py-[77px] flex items-center xl:w-[266px] xl:h-[266px] lg:w-[252px] lg:h-[252px] md:w-[360px] md:h-[360px] w-[175px] h-[175px] justify-center rounded-[50%] border-solid border-[1px] border-[#A8A8A8] bg-[transparent]`}
          >
            <Icon
